...
<aside class="app-sidebar <?php echo $theme === 'dark' ? 'theme-dark' : ''; ?>" id="appSidebar">
    ...
    <div class="sidebar-inner">
        <div class="sidebar-brand">
            <a href="/beta-assignment/student page/userOrder.php">
...
<script>
    (function () {
        ...
        if (sb && btn) {
            var hidden = localStorage.getItem('sidebar-hidden') === '1';
            if (hidden) document.body.classList.add('sidebar-collapsed');
            btn.addEventListener('click', function () {
                document.body.classList.toggle('sidebar-collapsed');
                localStorage.setItem('sidebar-hidden', document.body.classList.contains('sidebar-collapsed') ? '1' : '0');
